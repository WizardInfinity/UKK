...
// Pastikan produkID yang ada di URL valid
if (!isset($produkID) || empty($produkID)) {
    // Lakukan penanganan jika produkID tidak valid
...
$prdk = query("SELECT * FROM produk WHERE produkID = $produkID ")[0];
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <a href="dataProduk.php" type="button" class="btn btn-success" data-toggle="modal"
                    ...
                    <div class="row">
                        ...
                        <form action="" method="post">
                            <div class="mb-3">
                                ...
                                <input type="hidden" name="produkID" value="<?= $prdk["produkID"]; ?>">
                                <input type="text" class="form-control" id="exampleInputProduct" name="namaProduk"
                                    required value="<?= $prdk["namaProduk"]; ?>">
                            </div>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPrice" class="form-label">Harga</label>
                        <input type="number" class="form-control" id="exampleInputPrice" name="harga" required
                            value="<?= $prdk["harga"]; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputStock" class="form-label">Stok</label>
                        <input type="number" class="form-control" id="exampleInputStock" name="stok" required
                            value="<?= $prdk["stok"]; ?>">
                    </div>
