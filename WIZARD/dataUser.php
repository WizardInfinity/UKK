        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <?php
                    // Tampilkan tombol "Register" hanya jika pengguna memiliki peran "admin"
                    if ($userRole == 'admin') {
                        echo '<a href="register.php" type="button" class="btn btn-success" data-toggle="modal" data-target="#createModal">Register</a>';
                    }
                    ?>
