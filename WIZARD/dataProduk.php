        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <a href="tambahProduk.php" type="button" class="btn btn-success" data-toggle="modal"
                        ...
                        <table class="table" <tr>
                            ...
                            <?php foreach ($produk as $row): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="editProduk.php?produkID=<?= $row['produkID']; ?>"
                                            class="btn btn-warning">Edit</a>
                                        <a href="hapusProduk.php?produkID=<?= $row['produkID']; ?>" class="btn btn-danger"
