        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <a href="tambahPelanggan.php" type="button" class="btn btn-success" data-toggle="modal"
                        data-target="#createModal">Tambah</a>
                    <a href="detail.php" type="button" class="btn btn-primary" data-toggle="modal"
                        data-target="#createModal">Detail</a>
                        ...
                        <table class="table" <tr>
                            ...
                            <?php foreach ($pelanggan as $row): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="editPelanggan.php?pelangganID=<?= $row['pelangganID']; ?>"
                                            class="btn btn-warning">Edit</a>
                                        <a href="hapusProduk.php?produkID=<?= $row['pelangganID']; ?>"
                                            class="btn btn-danger"
                                            onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">Hapus</a>
                                        <a href="beliBarang.php?pelangganID=<?= $row['pelangganID']; ?>"
                                            class="btn btn-info">Beli Barang</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </table><br>
